  ...
  <ul class="layui-nav left fast-add" lay-filter="">
    <li class="layui-nav-item">
      ...
      <dl class="layui-nav-child"> <!-- 二级菜单 -->
        <dd><a onclick="x_admin_show('添加电影','jsp/uploadMovie.jsp')"><i class="iconfont">&#xe6a2;</i>电影</a></dd>
        <dd><a onclick="x_admin_show('添加新闻','jsp/addNews.jsp')"><i class="iconfont">&#xe6a8;</i>新闻</a></dd>
      </dl>
    </li>
  </ul>
  ...
  <div id="side-nav">
    <ul id="nav">
      ...
      <li >
        ...
        <ul class="sub-menu">
          <li><a _href="${pageContext.request.contextPath}/getData"><i class="iconfont">&#xe6a7;</i><cite>控制台</cite></a></li >
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a _href="/toUpdatePwd"><i class="iconfont">&#xe6a7;</i><cite>修改密码</cite></a></li >
        </ul>
      </li>
    </ul>
  </div>
  ...
  <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
    ...
    <div class="layui-tab-content">
      <div class="layui-tab-item layui-show">
        <iframe src="${pageContext.request.contextPath}/getData" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
      </div>
    </div>
  </div>
</div>
